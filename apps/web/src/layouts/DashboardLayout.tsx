...
export function DashboardLayout() {
    ...
    return (
        <div className="h-screen bg-[#F8F9FB] flex overflow-hidden font-sans">
            {/* Left Sidebar */}
            <aside className="w-64 bg-[#2D333D] text-slate-300 flex flex-col flex-shrink-0">
                ...
                <div className="px-4 mb-6">
                    <button className="w-full flex items-center justify-between p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors group">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-orange-400 border-2 border-green-500 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="flex-1 max-w-xl">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-2.5 bg-slate-50 border-transparent focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 rounded-xl outline-none transition-all placeholder:text-slate-400"
                            />
                        </div>
                    </div>
                ...
                {/* Footer with Rights */}
                <footer className="h-10 bg-white border-t border-slate-100 px-8 flex items-center justify-between text-[11px] text-slate-400 uppercase tracking-widest flex-shrink-0">
            ...
            <aside className="w-80 bg-white border-l border-slate-200 hidden xl:flex flex-col flex-shrink-0">
                <div className="p-6 border-b border-slate-100">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="font-bold text-slate-800 uppercase tracking-wider text-xs">Activity</h3>
                    ...
                    <div className="space-y-6">
                        <div className="relative pl-6 pb-6 border-l-2 border-slate-100 last:pb-0">
                            <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-blue-500 border-4 border-white shadow-sm"></div>
                            <p className="text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-wider">Today, July 30, 2019</p>
                            <div className="flex items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name=Tillie+Benson&background=3b82f6&color=fff" className="w-8 h-8 rounded-full" alt="" />
                                <div>
                                    <p className="text-sm font-semibold text-slate-800">Tillie Benson</p>
                                    <p className="text-xs text-slate-500">Fixed issue on dashboard</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative pl-6 pb-6 border-l-2 border-slate-100 last:pb-0">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-slate-800">Jim Miller</p>
                                    <p className="text-xs text-slate-500">Uploaded 4 attachments</p>
                                </div>
                            </div>
                        </div>
                    </div>
